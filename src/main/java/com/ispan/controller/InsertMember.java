...
//		System.out.println(password_Hashing);
		...
		MemberBean member_ans = member.insert(full_name,username,password_Hashing,email,total_miles,phone_number,registration_date,email_verified,phone_verified,membership_level);
